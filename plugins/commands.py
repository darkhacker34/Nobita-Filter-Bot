...
async def start(client, message):
    ...
    if data.startswith("sendfiles"):
        ...
        if (
            ...
            [
                InlineKeyboardButton('⁉️  ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ  ⁉️', url="https://youtu.be/GdaUbzxDTKs")
            ]
            ]
        else:
            ...
            try:
                ...
                msg = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("❤️‍🔥 ᴄʜᴀɴɴᴇʟ​ ❤️‍🔥", url="https://t.me/MV_Rockers")
                         ]
                        ]
                    )
                )
...
async def tutorial(bot, message):
    btn = [[
        ...
        InlineKeyboardButton(text="ᴀᴅᴅ  ʏᴏᴜʀ ɢʀᴏᴜᴘ", url="http://telegram.me/Series_LaabBot?startgroup=true")
    ]]
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
